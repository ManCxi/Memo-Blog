!(function (e, t) {
  ...
  return (function () {
    ...
    function b(e) {
      ...
      return (
        e instanceof Date ||
          ('string' == typeof e && /^\d{4}-\d{2}-\d{2}$/.test(e) && (e += 'T00:00:00'),
          (t = new Date(e))),
        isNaN(t.getTime()) &&
    ...
    class C {
      ...
      init() {
        ...
        (i &&
          ...
          null !== (e = this.customData) && void 0 !== e && e.disabled
            ...
            : !1 === (null === (t = this.customData) || void 0 === t ? void 0 : t.disabled) &&
      ...
      _createElement() {
        var e;
        let { year: t, month: i, fullMonth: s, date: a, fullDate: r } = o(this.date),
          h = (null === (e = this.customData) || void 0 === e ? void 0 : e.attrs) || {};
        ((this.$cell = n({
          attrs: {
            'data-year': t,
            'data-month': i,
    ...
    class R {
        ...
        if (
          ...
          I(this, 'update', function () {
            let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
              ...
              { silent: a } = t;
            w(r.opts, e);
            let { timepicker: n, buttons: h, range: o, selectedDates: l, isMobile: d } = r.opts,
      ...
      init() {
        ...
        ((!B || (B && P && !o.contains(P))) &&
          ...
          this.elIsInput &&
            (i || this._bindEvents(), r && !h && (this.keyboardNav = new O({ dp: this, opts: e }))),
      ...
      selectDate(e) {
        ...
        if ((e = b(e)) instanceof Date) {
          if (v && !o && !v({ date: e, datepicker: this })) return Promise.resolve();
          if (
            (a === i.days &&
              e.getMonth() !== n.month &&
              l &&
