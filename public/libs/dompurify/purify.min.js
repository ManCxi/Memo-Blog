...
!(function (e, t) {
  ...
  var V = (function t() {
    ...
    const o = (e) => t(e);
    if (((o.version = '3.0.3'), (o.removed = []), !n || !n.document || 9 !== n.document.nodeType))
    ...
    const mt = function (e) {
      ...
      yt = function (e) {
        ...
        return e instanceof b && !mt(e)
          ? (ut(e), !0)
          : ('noscript' !== n && 'noembed' !== n) || !E(/<\/no(script|embed)/i, e.innerHTML)
            ? (Re &&
                3 === e.nodeType &&
                ((t = e.textContent),
                (t = g(t, ae, ' ')),
    ...
    return (
      (o.sanitize = function (e) {
        ...
        if (ve) {
          ...
          return ((ge.shadowroot || ge.shadowrootmod) && (a = re.call(r, a, !0)), a);
        }
