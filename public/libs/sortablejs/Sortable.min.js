...
!(function (t, e) {
  ...
  function l(t, e) {
    ...
    if (Object.getOwnPropertySymbols)
      for (var i = Object.getOwnPropertySymbols(t), r = 0; r < i.length; r++)
        ((n = i[r]), -1 === e.indexOf(n) && {}.propertyIsEnumerable.call(t, n) && (o[n] = t[n]));
    return o;
  }
  function e(t) {
    return (
  ...
  function P(t, e, n, o) {
    if (t) {
      n = n || document;
      do {
        if ((null != e && ('>' !== e[0] || t.parentNode === n) && g(t, e)) || (o && t === n))
          return t;
      } while (t !== n && (t = m(t)));
    }
    return null;
  ...
  function k(t, e, n) {
    ...
    t &&
      ...
      (t.classList
        ...
        : ((o = (' ' + t.className + ' ').replace(b, ' ').replace(' ' + e + ' ', ' ')),
      ...
      if ((e || n) && t !== window && ((i = i || t.parentNode), !y))
        do {
          if (
            ...
            ('none' !== R(i, 'transform') || (n && 'static' !== R(i, 'position')))
          ) {
  ...
  function j(t, e) {
    ...
    for (; (t = t.previousElementSibling); )
      'TEMPLATE' === t.nodeName.toUpperCase() || t === Ht.clone || (e && !g(t, e)) || n++;
    return n;
  }
  function S(t) {
    var e = 0,
          ...
          this.options.animation &&
            [].slice.call(this.el.children).forEach(function (t) {
              ...
              'none' !== R(t, 'display') &&
                ...
                !t.thisAnimationDuration || ((n = D(t, !0)) && ((e.top -= n.f), (e.left -= n.e))),
                (t.fromRect = e));
            }));
      },
  ...
  function Ht(t, e) {
    ...
    ((this.nativeDraggable = !e.forceFallback && Pt),
      ...
      e.supportPointer
        ...
        : (f(t, 'mousedown', this._onTapStart), f(t, 'touchstart', this._onTapStart)),
  ...
  ((Ht.prototype = {
    ...
    _prepareDragStart: function (t, e, n) {
      ...
      n &&
        ...
        (nt = n),
        (ct = a.group),
        (dt = { target: (Ht.dragged = $), clientX: (e || t).clientX, clientY: (e || t).clientY }),
        ...
        f(l, 'touchmove', Ft),
        a.supportPointer
          ? (f(l, 'pointerup', i._onDrop), this.nativeDraggable || f(l, 'pointercancel', i._onDrop))
          : (f(l, 'mouseup', i._onDrop),
            f(l, 'touchend', i._onDrop),
            f(l, 'touchcancel', i._onDrop)),
        c && this.nativeDraggable && ((this.options.touchStartThreshold = 4), ($.draggable = !0)),
        ...
        !a.delay || (a.delayOnTouchOnly && !e) || (this.nativeDraggable && (w || y))
          ...
          : Ht.eventCanceled
            ...
            : (a.supportPointer
              ...
              a.supportPointer && f(l, 'pointermove', i._delayedDragTouchMoveHandler),
    ...
    _emulateDragOver: function () {
      if (ht) {
        ...
        for (
          ...
          t && t.shadowRoot && (t = t.shadowRoot.elementFromPoint(ht.clientX, ht.clientY)) !== e;
        )
          e = t;
    ...
    _appendGhost: function () {
      if (!J) {
        ...
        if (Nt) {
          for (
            Dt = t;
            'static' === R(Dt, 'position') && 'none' === R(Dt, 'transform') && Dt !== document;
          )
            Dt = Dt.parentNode;
          (Dt !== document.body && Dt !== document.documentElement
            ? (Dt === document && (Dt = O()), (e.top += Dt.scrollTop), (e.left += Dt.scrollLeft))
            : (Dt = O()),
            (xt = S(Dt)));
        }
          ...
          : (q('setupClone', this),
            ...
            e
              ...
              : (p(document, 'mouseup', n._onDrop),
                ...
                o && ((o.effectAllowed = 'move'), i.setData && i.setData.call(n, o, $)),
                f(document, 'drop', n),
        ...
        if (
          ...
          u &&
            ...
            (d
              ? h || (i = Q !== tt)
              : ut === this ||
                ((this.lastPutMode = ct.checkPull(this, u, $, n)) && c.checkPut(this, u, $, n))))
        ) {
          if (
          ...
          if (
            ...
            !(c
              ...
              : S.clientY > E.bottom + 10 || (S.clientX > x.right && S.clientY > x.top)) ||
              m.animated)
          ) {
            if (
              m &&
              ...
              if (
                (bt !== l && ((y = D[_]), (Ct = !1), (Tt = (!S && s.invertSwap) || E)),
                0 !==
                  (b = (function (t, e, n, o, i, r, a, l) {
                    ...
                    if (!a)
                      if (l && wt < c * i) {
                        if (
                          (Ct =
                            !Ct && (1 === yt ? t + (c * r) / 2 < s : s < o - (c * r) / 2) ? !0 : Ct)
                        )
                          n = !0;
                ...
                for (
                  var T = j($);
                  (w = Q.children[(T -= b)]) && ('none' === R(w, 'display') || w === J);
                );
              ...
              if (!1 !== S)
                return (
                  ...
                  setTimeout(Wt, 30),
                  M(),
                  E && !x ? a.appendChild($) : l.parentNode.insertBefore($, E ? x : l),
            ...
            if (
              ...
              return (
                M(),
                m && m.nextSibling ? a.insertBefore($, m.nextSibling) : a.appendChild($),
                (Q = a),
                N(),
                A(!0)
              );
      ...
      function A(t) {
        return (
          ...
          t &&
            ...
            p !== f && (k($, (ut || u).options.ghostClass, !1), k($, s.ghostClass, !0)),
    ...
    _onDrop: function (t) {
      ...
      ((at = j($)),
        ...
        Ht.eventCanceled ||
          ...
          R($, 'transform', ''),
          t &&
            (vt && (t.cancelable && t.preventDefault(), n.dropBubble || t.stopPropagation()),
            ...
            $ &&
              ...
              tt !== Q
                ? (0 <= at &&
                    (Z({ rootEl: Q, name: 'add', toEl: Q, fromEl: tt, originalEvent: t }),
                    Z({ sortable: this, name: 'remove', toEl: Q, originalEvent: t }),
                    Z({ rootEl: Q, name: 'sort', toEl: Q, fromEl: tt, originalEvent: t }),
                    Z({ sortable: this, name: 'sort', toEl: Q, originalEvent: t })),
                  ut && ut.save())
                : at !== rt &&
                  0 <= at &&
                  (Z({ sortable: this, name: 'update', toEl: Q, originalEvent: t }),
                  Z({ sortable: this, name: 'sort', toEl: Q, originalEvent: t })),
              Ht.active &&
    ...
    ie = C(function (n, t, e, o) {
      if (t.scroll) {
        var i,
          ...
          u = !1;
        qt !== e &&
          ((qt = e), ee(), (Ut = t.scroll), (i = t.scrollFn), !0 === Ut && (Ut = M(e, !0)));
        var d = 0,
          h = Ut;
        do {
          var f = h,
            ...
            (0 == T && 0 == p) ||
              ...
              (Jt[d].pid = setInterval(
                function () {
                  ...
                  ('function' == typeof i &&
                    'continue' !==
                      i.call(Ht.dragged.parentNode[K], e, t, n, $t, Jt[this.layer].el)) ||
            ...
            dragOverAnimationCapture: function (t) {
              ...
              (he.forEach(function (t) {
                ...
                t.options.animation &&
                  ...
                  ((ue = a({}, e)), (e = D(ce, !0)), (ue.top -= e.f), (ue.left -= e.e)));
            },
              ...
              s &&
                ...
                me ||
                  ...
                  ~he.indexOf(ce)
                    ...
                    : (he.push(ce),
                      U({ sortable: d, rootEl: c, name: 'select', targetEl: ce, originalEvent: s }),
                      s.shiftKey && le && d.el.contains(le)
                        ? ((r = j(le)),
                          ...
                          ~r &&
                            ...
                            (function () {
                              for (
                                var e, t = r < a ? ((e = r), a) : ((e = a), r + 1), n = o.filter;
                                e < t;
                                e++
                              )
                                ~he.indexOf(i[e]) ||
            ...
            utils: {
              select: function (t) {
                ...
                e &&
                  e.options.multiDrag &&
                  !~he.indexOf(t) &&
                  (se && se !== e && (se.multiDrag._deselectMultiDrag(), (se = e)),
