var TurndownService = (function () {
  ...
  ((t.paragraph = {
    ...
    (t.heading = {
      ...
      replacement: function (e, n, t) {
        n = Number(n.nodeName.charAt(1));
        return 'setext' === t.headingStyle && n < 3
          ? '\n\n' + e + '\n' + u(1 === n ? '=' : '-', e.length) + '\n\n'
          : '\n\n' + u('#', n) + ' ' + e + '\n\n';
      },
    }),
    ...
    (t.listItem = {
      ...
      replacement: function (e, n, t) {
        e = e.replace(/^\n+/, '').replace(/\n+$/, '\n').replace(/\n/gm, '\n    ');
        var r,
          t = t.bulletListMarker + '   ',
          i = n.parentNode;
        return (
          'OL' === i.nodeName &&
            ((r = i.getAttribute('start')),
            (i = Array.prototype.indexOf.call(i.children, n)),
            (t = (r ? Number(r) + i : i + 1) + '.  ')),
          t + e + (n.nextSibling && !/\n$/.test(e) ? '\n' : '')
        );
      },
    ...
    (t.fencedCodeBlock = {
      ...
      replacement: function (e, n, t) {
        for (
          var r,
            i = ((n.firstChild.getAttribute('class') || '').match(/language-(\S+)/) || [
              null,
              '',
            ])[1],
    ...
    (l.prototype = {
      ...
      forNode: function (e) {
        return e.isBlank
          ? this.blankRule
          : (n = s(this.array, e, this.options)) ||
              (n = s(this._keep, e, this.options)) ||
              (n = s(this._remove, e, this.options))
            ? n
            : this.defaultRule;
        var n;
      },
  ...
  function v(e, n) {
    var n = {
        ...
        isBlock: f,
        isVoid: d,
        isPre: n.preformattedCode ? y : null,
      },
      t = n.element,
      r = n.isBlock,
      i = n.isVoid,
    ...
    if (t.firstChild && !o(t)) {
      for (var a = null, l = !1, u = h((s = null), t, o); u !== t; ) {
        if (3 === u.nodeType || 4 === u.nodeType) {
          var c = u.data.replace(/[ \r\n\t]+/g, ' ');
          if (!(c = (a && !/ $/.test(a.data)) || l || ' ' !== c[0] ? c : c.substr(1))) {
            u = p(u);
            continue;
          }
          ((u.data = c), (a = u));
          ...
          r(u) || 'BR' === u.nodeName
            ? (a && (a.data = a.data.replace(/ $/, '')), (a = null), (l = !1))
            : i(u) || o(u)
              ? (l = !(a = null))
              : a && (l = !1);
        }
      ...
      a && ((a.data = a.data.replace(/ $/, '')), a.data || p(a));
    }
    return e;
  }
  function y(e) {
  ...
  function N(e, n) {
    ...
    return (
      ...
      (e.flankingWhitespace = (function (e, n) {
        if (e.isBlock || (n.preformattedCode && e.isCode)) return { leading: '', trailing: '' };
        var t = (function (e) {
          e = e.match(/^(([ \t\r\n]*)(\s*))(?:(?=\S)[\s\S]*\S)?((\s*?)([ \t\r\n]*))$/);
          return {
            leading: e[1],
        ...
        t.leadingAscii && E('left', e, n) && (t.leading = t.leadingNonAscii);
        t.trailingAscii && E('right', e, n) && (t.trailing = t.trailingNonAscii);
  ...
  function E(e, n, t) {
    var r,
      i,
      e = 'left' === e ? ((r = n.previousSibling), / $/) : ((r = n.nextSibling), /^ /);
    return (
      r &&
        (3 === r.nodeType
          ? (i = e.test(r.nodeValue))
          : t.preformattedCode && 'CODE' === r.nodeName
            ? (i = !1)
            : 1 !== r.nodeType || f(r) || (i = e.test(r.textContent))),
      i
    );
  }
  ...
  function k(e) {
    ...
    return T.call(
      ...
      function (e, n) {
        var t = '';
        return (
          3 === (n = new N(n, r.options)).nodeType
  ...
  function b(e, n) {
    var t = (function (e) {
      ...
      r = n.replace(/^\n*/, ''),
      e = Math.max(e.length - t.length, n.length - r.length);
    return t + '\n\n'.substring(0, e) + r;
  }
  return (
    (C.prototype = {
      turndown: function (e) {
        if (
          null == (n = e) ||
          ('string' != typeof n &&
            (!n.nodeType || (1 !== n.nodeType && 9 !== n.nodeType && 11 !== n.nodeType)))
        )
          throw new TypeError(e + ' is not a string, or an element/document/fragment node.');
        if ('' === e) return '';
        var n = k.call(this, new v(e, this.options));
        return function (n) {
          var t = this;
          return (
            this.rules.forEach(function (e) {
              'function' == typeof e.append && (n = b(n, e.append(t.options)));
            }),
            n.replace(/^[\t\r\n]+/, '').replace(/[\t\r\n\s]+$/, '')
          );
        }.call(this, n);
